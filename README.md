...
This project is a fully autonomous Pac-Man game implemented in Python using Pygame. Unlike traditional versions of Pac-Man that rely on player input, Pac-Man in this game is controlled entirely by artificial intelligence. The agent continuously evaluates the maze, ghost positions, and game state to make real-time decisions using A* pathfinding combined with safety heuristics.

The project demonstrates applied algorithms, real-time decision making, and modular game architecture.
