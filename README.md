...
Dynamic target selection based on ghost proximity, power mode, and pellet safety
...
Randomized movement to reduce predictability
...
Ghost proximity penalties dynamically added to path cost
